...
data_part1 <- read_excel(phosphosite_file, sheet = "Protein abundance", range = "A2:B1983")
data_part2 <- read_excel(phosphosite_file, sheet = "Protein abundance", range = "V2:AK1983")
output_file <- "/Users/tylersisley/Documents/ANOVA R scripts/Table_S5_protein_TukeyHSD.xlsx"
